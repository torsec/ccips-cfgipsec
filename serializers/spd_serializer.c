...
int cser_raw_store_struct_spd_entry_node (const struct spd_entry_node *val, cser_raw_write_fn w, void *q)
{
 ...
 {
    {
      int ret = cser_raw_store_int ((int*)&val->index, w, q);
      if (ret != 0)
        return ret;
   }
 ...
 {
    {
      int ret = cser_raw_store_unsigned_short ((unsigned short*)&val->policy_dir, w, q);
      if (ret != 0)
        return ret;
   }
 ...
 {
    {
      int ret = cser_raw_store_unsigned_short ((unsigned short*)&val->action, w, q);
      if (ret != 0)
        return ret;
   }
 ...
 {
    {
      int ret = cser_raw_store__Bool ((_Bool*)&val->pfp_flag, w, q);
      if (ret != 0)
        return ret;
   }
 ...
 {
    {
      int ret = cser_raw_store__Bool ((_Bool*)&val->stateful_frag_check, w, q);
      if (ret != 0)
        return ret;
   }
...
int cser_raw_load_struct_spd_entry_node (struct spd_entry_node *val, cser_raw_read_fn r, void *q)
{
 ...
 {
      int ret = cser_raw_load_int ((int*)&val->index, r, q);
    if (ret != 0)
      return ret;
 }
 {
      int ret = cser_raw_load_unsigned_short ((unsigned short*)&val->policy_dir, r, q);
    if (ret != 0)
      return ret;
 }
 {
 ...
 {
      int ret = cser_raw_load_unsigned_short ((unsigned short*)&val->action, r, q);
    if (ret != 0)
      return ret;
 }
 {
 ...
 {
      int ret = cser_raw_load__Bool ((_Bool*)&val->pfp_flag, r, q);
    if (ret != 0)
      return ret;
 }
 {
      int ret = cser_raw_load__Bool ((_Bool*)&val->stateful_frag_check, r, q);
    if (ret != 0)
      return ret;
 }
 {
...
int cser_raw_store_int (const int *val, cser_raw_write_fn w, void *q)
{
  ...
  for (unsigned i = 1; i <= sizeof (int); ++i)
  {
    bytes[sizeof (int) - i] = (uint8_t)(tmp & 0xff);
    tmp >>= 8;
  }
  return w (bytes, sizeof (int), q);
}
int cser_raw_load_int (int *val, cser_raw_read_fn r, void *q)
{
  uint8_t bytes[sizeof (int)];
  int ret = r (bytes, sizeof (int), q);
  if (ret != 0)
    return ret;
  int tmp = 0;
