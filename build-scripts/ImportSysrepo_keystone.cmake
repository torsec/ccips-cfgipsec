...
target_link_libraries(${host_bin} PUBLIC pthread)


message(STATUS "Looking for libyang")
find_package(LibYANG REQUIRED)
target_link_libraries(${host_bin} PUBLIC ${LIBYANG_LIBRARIES})
...
target_link_libraries(${host_bin} PUBLIC ${SYSREPO_LIBRARIES})
